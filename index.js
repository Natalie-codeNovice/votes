...
const dbConfig = {
    host: 'bd4faowzpg7gdo8wltaq-mysql.services.clever-cloud.com',
    user: 'unj5dikv6z3gvrec',
    password: 'YK3pCbROZuklkjmBtaxE', // Replace with your MySQL password
    database: 'bd4faowzpg7gdo8wltaq'
};
